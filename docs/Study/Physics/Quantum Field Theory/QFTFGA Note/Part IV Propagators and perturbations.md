...
free part 
$\mathcal{L}_{0}=\frac{1}{2}\left (\partial_{\mu} \phi\right)^{2}-\frac{m^{2}}{2} \phi^{2}$ , 
$\hat{\mathcal{H}}_{0}=\frac{1}{2}\left[\left (\frac{\partial \hat{\phi}}{\partial t}\right)^{2}+(\boldsymbol{\nabla} \hat{\phi})^{2}+m^{2} \hat{\phi}^{2}\right]$，
